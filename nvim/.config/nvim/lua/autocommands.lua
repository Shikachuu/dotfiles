vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
    ...
    vim.keymap.set("n", "<leader>gr", telescope.lsp_references, { buffer = event.buf, desc = "[g]oto [r]eferences" })
    ...
    vim.keymap.set({ "n", "x" }, "<C-A-l>", require("conform").format, { buffer = event.buf, desc = "Format [C-A-l]" })
    ...
    vim.keymap.set("n", "<leader>wd", telescope.diagnostics, { buffer = event.buf, desc = "[w]orkspace [d]iagnostics" })
  end,
})
